...
class Game {
    constructor() {
        this.ball = new Ball(canvas.width / 4, canvas.height / 2, 10, 4, 4);
        this.ball2 = new Ball(canvas.width / 4, canvas.height / 2, 7, 8, 8);
        this.ball3 = new Ball(canvas.width / 4, canvas.height / 2, 20, 2, 2);
        this.ball4 = new Ball(canvas.width / 4, canvas.height / 2, 3, 1, 1);
        this.ball5 = new Ball(canvas.width / 4, canvas.height / 2, 5, 3, 3);
    ...
    draw() {
        ...
        this.ball2.draw('red');
        this.ball3.draw('blue');
        this.ball4.draw('green');
        this.ball5.draw('yellow');
        this.paddle1.draw('orange');
        this.paddle2.draw('purple');
    }
    update() {
        this.ball.move();
        this.ball2.move();
